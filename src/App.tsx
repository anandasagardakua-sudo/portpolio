...
const App = () => {
  ...
  const studentData = {
    ...
    contact: {
      ...
      github: "https://github.com/anandasagardakua-sudo",
    ...
    profileImage: "https://instasize.com/p/db8406e12159a4d4438ab82a8a6185840b8f12022141699dc867e646c3f3e7e2",
    resumeUrl: "https://instasize.com/p/db8406e12159a4d4438ab82a8a6185840b8f12022141699dc867e646c3f3e7e2", // Please provide a direct link to your resume PDF
    projects: [
      {
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white border border-slate-200 text-slate-900 px-8 py-3 rounded-xl font-medium flex items-center gap-2 hover:border-indigo-600 hover:text-indigo-600 transition-all shadow-sm"
              >
